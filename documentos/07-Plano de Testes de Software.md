...
| Passos | 1) Acesse o navegador <br> 2) Informe a URL <br> 3) Visualizar a página inicial <br> 4) Clicar no ícone "+" <br> 5) Cadastrar 3 transações distintas com êxito (receita, despesa e poupança). |
